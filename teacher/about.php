...
<body>
    ...
    <div id="wrapper">
        <div id="page">
            ...
            <!--Header Start-->
            <div id="header" style="background-color: #e4eefd">

                <div class="logo-part">

                    <!--Logo Start-->
                    <div class="logo"><a href="index-2.html"><img src="../images/logoschool.png" width="550" height="140"
                                alt="" /></a></div>
                    <!--Logo End-->
                </div>
                ...
                <div>
                    <div >
                        <div class="menu-inner"  style="text-align: center; background-color: dodgerblue">
                            <ul id="main_menu">
            ...
            <div id="content">
                ...
                <div class="inner-part">
                    ...
                    <div class="inner-left">
                        ...
                        <h2><img src="images/about-image.png" width="649" height="241" alt="" /></h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            been the industry's standard dummy text ever since the 1500s, when an unknown printer took a
                            galley of type and scrambled itto make a type specimen book.Lorem Ipsum has been the
                            industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                            of type and scrambled it to make galley industry's standard of type a type specimen book.
                        </p>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-inner">
                            <div class="sidebar-top"><img src="images/sitebar-top.png" width="269" height="20" alt="" />
                            </div>
                            <div class="sidebar-center">

                                <!--Download Part Start-->
                                <div class="download"><a href="#"><img src="images/download.png" width="202" height="43"
                                            alt="" /></a></div>
                                <!--Download Part End-->
                                ...
                                <div class="event-cal">
                                    <h1>Campus Event Calender<img src="images/rss.png" width="17" height="17" alt=""
                                            class="rss" /></h1>
                                    ...
                                    <div class="view-inner"><a href="#"><img src="images/view.png" width="158"
                                                height="37" alt="" /></a></div>
                                </div>
                                ...
                                <div class="cam-news">
                                    <h1>Campus News <img src="images/rss.png" width="17" height="17" alt=""
                                            class="rss" /></h1>
                            ...
                            <div class="sidebar-center"><img src="images/sitebar-bottom.png" width="269" height="20"
                                    alt="" /></div>
            ...
            <div class="footer-top">
                <div class="footer-top-inner">
                    ...
                    <div class="footer-menu">
                        ...
                        <div class="about">
                            ...
                            <p>It is a long established fact that a reader will be distracted by the readable content of
                                ...
                                more-or-less normal distribution of letters, as opposed to using 'Content here, content
                                here', making it look like readable English.<a href="#">Read More +</a></p>
                        </div>
                    ...
                    <div class="footer-bottom">
                        ...
                        <div class="footer-copy">Copyright &copy; 2012 Wieldstrem University. All Rights
                            Reserved.<br />Wieldstrem University, Strem Valley , Stoviana 258963.<br />
                            <b>Call : 1800-895-985 <a href="#">|</a> Fax : 859 582 6975 <a href="#">|</a> Email :
                                info@wieldstremuniversity.com</b>
                        </div>
                        <!--Copyright Part End-->

                        <!--Footer logo Part Start-->
                        <div class="footer-logo"><img src="images/footer-logo.png" width="262" height="57" alt="" />
                        </div>
