<?php
    ...
    $Student_query = "  SELECT students.*, logins.*
                        FROM students 
            ...
            <div class="form first">
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <input disabled value="<?php echo $row['last_name'] ?>" name="last_name" id="last_name" type="text"
                            placeholder="Nhập họ tên" required>
                    </div>
                    <div class="input-field">
                        <label>Tên</label>
                        <input disabled value="<?php echo $row['first_name'] ?>" name="first_name" id="first_name" type="text"
                            placeholder="Nhập họ tên" required>
                    </div>
                    <div class="input-field">
                        <label>Sinh ngày</label>
                        <input disabled value="<?php echo date("Y-m-d", strtotime($row['dob'])) ?>" name="dob" id="dob"
                            type="date" required>
                    </div>
                    <div class="input-field">
                        ...
                        <select name="gender" id="gender" required>
                            ...
                            <option disabled value='Nam' <?php if($row["gender"] == 'Nam') echo 'selected'; ?>>Nam</option>
                            <option disabled value='Nữ' <?php if($row["gender"] == 'Nữ') echo 'selected'; ?>>Nữ</option>
                        </select>
                    </div>
                    <div class="input-field">
                        <label>Địa chỉ</label>
                    ...
                    <div class="input-field">
                        ...
                        <input disabled value="<?php echo $row['phone'] ?>" name="phone" id="phone" type="number"
                            placeholder="Nhập số điện thoại" required>
                    </div>
                    <div class="input-field">
                        <label>Tài khoản</label>
                        <input disabled value="<?php echo $row['email'] ?>" name="email" id="email" type="text"
